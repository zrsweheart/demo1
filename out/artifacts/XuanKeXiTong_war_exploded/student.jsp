...
<body class="bg">
<h2 style="text-align: center;">你好！同学，请选择以下操作</h2>
<br>
<div style="text-align: center;">
    <a href="update.jsp" target="_self">修改个人信息</a><br>
    <a href="add.jsp" target="_self">浏览课程信息</a><br>
    <a href="add.jsp" target="_self">选课</a><br>
